...
> [**「병역법 제2조제17항」**](https://www.law.go.kr/%EB%B2%95%EB%A0%B9/%EB%B3%91%EC%97%AD%EB%B2%95/%EC%A0%9C2%EC%A1%B0) “산업기능요원”이란 산업을 육성하고 지원하기 위하여 제36조에 따라 산업기능요원(產業技能要員)으로 편입되어 해당 분야에 복무하는 사람을 말한다.
...
> [!TIP]
> If running this project outside of South Korea, set the `MMA_PROXY` environment variable to bypass `work.mma.go.kr` IP restrictions (e.g., `export MMA_PROXY=http://host:port`).
